...
//                                     <div>
//                                         <MDBCardText className="mb-1 h5">mentorData.mentis</MDBCardText>
//                                         <MDBCardText className="small text-muted mb-0">Mentis</MDBCardText>
//                                     </div>
//                                     <div className="px-3">
//                                         <MDBCardText className="mb-1 h5">mentorData.likes</MDBCardText>
...
//                                     <div className="p-4" style={{ backgroundColor: '#f8f9fa' }}>
//                                         <MDBCardText className="font-italic mb-1">mentorData.philosophy</MDBCardText>
//
//                                     </div>
//                                 </div>
//                                 <div className="d-flex justify-content-between align-items-center mb-4">
//                                     <MDBCardText className="lead fw-normal mb-0">Contacts</MDBCardText>
//                                 </div>
//                                 <MDBRow>
        ...
        <div >
            {(mentorData == null) ? (<h1>the mentor is not exist</h1> ):
                (<div>
                    ...
                    {/*<h4>mentor id: {id}</h4>*/}
                    <PersonalHeader name={mentorData?.name} img={avatars[id]} />
